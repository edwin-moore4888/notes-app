...
export function NoteList({ availableTags, notes, onUpdateTag, onDeleteTag}: NoteListProps) {
    ...
    const filteredNotes = useMemo(() => {
        return notes.filter(note => {
            ...
            // loop through all of selected tags and make sure that it returns true... check note to see if it has all notes looked for
    ...
    return (
        ...
        <Row className="align-items-center mb-4">
            ...
            {/* set the content to as small as possible to push is all the way to the right */}
            <Col xs='auto'>
